...
* [Циклы repeat](#циклы-repeat)
* [Циклы while](#циклы-while)
* [Циклы for](#циклы-for)
* [for против векторизации ](#for-против-векторизации)
* [Задача ](#задача)
* [Пакеты(packages)](#пакетыpackages)
* [Подключение пакетов ](#подключение-пакетов)
* [Пакеты(packages)](#пакетыpackages)
* [Установка пакетов из CRAN](#установка-пакетов-из-cran)
